# AI Prompt: prompt-epic-47be9e5c-03-feature-02-story-01-1769996585483

**Story ID:** epic-47be9e5c-03-feature-02-story-01
**Role:** Software Engineer
**Task:** Implement feature from user story
**Template:** Prompt-muse-User-Story-Implementation-PR
**Generated:** 2026-02-02T01:43:05.483Z
...
- Default Branch: main
- Current Branch: muse/epic-47be9e5c-03-feature-02-story-01-implementation

**User Story:**

- ID: epic-47be9e5c-03-feature-02-story-01
- Title: PII Detection Engine
- Role: authorized system service
- Capability: detect PII patterns
- Benefit: prevent data exposure

**Acceptance Criteria:**
1. System scans documents for Social Security Numbers using pattern matching for XXX-XX-XXXX format variations
2. System identifies configurable PII elements including names, addresses, phone numbers, and dates of birth
3. System calculates and returns confidence score between 0-100 for each detected PII element
4. System flags documents containing detected PII elements for processing before any transfer operation

**Related Artifacts:**

- Feature ID: epic-47be9e5c-03-feature-02
- Feature Title: Automate PII Redaction and Concealment
- Epic ID: epic-47be9e5c-03
- Epic Title: Enforce Privacy Act Compliance and Access Controls
- Governance References: - sec-47be9e5c-182-62d0c42d
...
generated_at: 2026-02-02T01:37:02.291Z
...
```plaintext
muse/epic-47be9e5c-03-feature-02-story-01-implementation
```plaintext
...
```plaintext
epic-47be9e5c-03-feature-02-story-01: <concise description>
...
```plaintext
epic-47be9e5c-03-feature-02-story-01: implement requested functionality
...
```plaintext
epic-47be9e5c-03-feature-02-story-01 — PII Detection Engine
```plaintext
...
---
*This prompt was generated at 2026-02-02T01:43:05.483Z and is immutable at retrieval time.*
