...
---
# Document Metadata Retrieval API — implementation path

## User Story
As a platform engineer, I want to implement document metadata retrieval api for the implementation path, so that I can satisfy governance requirements for the implementation path.
